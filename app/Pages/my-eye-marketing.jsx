    ...
    return (
      <div id="myEyeMarketing">
        <div id="menuContainer">
          <Link id="navLink" to="/"><button id="navBtn"><BlinkingEyeBtn type = 'global' handleEvent = {false} id="smallBtn" name="home" text="HEM" /></button></Link>
          ...
          <Link id="navLink" to="/layout"><button id="navBtn"><BlinkingEyeBtn type = 'global' handleEvent = {false} id="smallBtn" name ="layoutPanel" text="LAYOUT PANEL" /></button></Link>
